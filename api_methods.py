...
# def is_user_subscribed_to_channel(youtube, user_id, channel_id):
...
#         subscribed_channel_id = item["snippet"]["channelId"]
#         if subscribed_channel_id == channel_id:
#             return True  # Kullanıcı belirli kanala abone ise True döndür

#     return False

# def get_subscribed_comments(youtube, video_ids, channel_id):
#     subscribed_comments = []
...
#             # Kullanıcının belirli kanala abone olup olmadığını kontrol et
#             is_subscribed = is_user_subscribed_to_channel(youtube, user_id, channel_id)

#             # Kullanıcı abone ise, yorumu listeye ekle
#             if is_subscribed:
#                 subscribed_comments.append(comment)

#     return subscribed_comments

# mine=True parametresi ile kullanıcının kendi kanalına abone olup olmadığını kontrol edebilirsin, bizim bu kanalın aboneliklerini listeleme yetkimiz yoktur.
